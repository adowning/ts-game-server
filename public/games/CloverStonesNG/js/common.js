...
nge.statisticsCollector = new function () {
    var _apiUrl =  '/game/CloverStonesNG/server?sessionId='+sessionStorage.getItem('sessionId');
    var _sesId = false;
    var _query = [];
    var _lastSendCall;
                        ...
                        if (loadCfg) {
                            nge.Lib.Helper.recursiveSet(
                                ...
                                loadCfg.extend(function () {
                                    var antiCacheSuffix = nge.assets.getAntiCacheSuffix();
                                    var heavyPath = nge.realPathPrefix + 'games/CloverStonesNG/css/fonts/FuturaPT-Heavy.otf' + antiCacheSuffix;
                                    var mediumPath = nge.realPathPrefix + 'games/CloverStonesNG/css/fonts/FuturaPT-Medium.otf' + antiCacheSuffix;
