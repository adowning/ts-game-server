...
$jscomp.scope = {}, $jscomp.arrayIteratorImpl = function(t) {
    ...
    function(t) {
        ...
        o.e = function(t) {
            ...
            if (0 !== n)
                if (n) e.push(n[2]);
                    ...
                    s.charset = "utf-8", s.timeout = 120, o.nc && s.setAttribute("nonce", o.nc), s.src = o.p + "games/CloverStonesNG/app/cloverstones.7/" + ({
                        0: "game",
                        2: "vendors~vendor"
                    } [t] || t) + ".js";
                    var c = Error(),
        ...
        window.WEBPACK = !0, window.WEBPACK_VERSION = 1, window.GAMECODE = "249", window.MODE = "production", window.gameVersion = "(build 7 commit 294823ec21d0f044d91123d65ebb70ecb17969fc)", window.loadPackedVendorBundles = function() {
