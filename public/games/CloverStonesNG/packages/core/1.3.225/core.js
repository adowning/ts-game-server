...
$jscomp.scope = {}, $jscomp.ASSUME_ES5 = !1, $jscomp.ASSUME_NO_NATIVE_MAP = !1, $jscomp.ASSUME_NO_NATIVE_SET = !1, $jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(e, t, n) {
    ...
    function(e) {
        ...
        n(1), n(2), n(9), n(168), n(194), n(209), window.nge._versions = window.nge._versions || {}, window.nge._versions.core = JSON.stringify("1.3.225") || "local"
    }, function(e, t) {
        ...
        nge.Com.Base = Class.extend((function() {
            ...
            this.preload = function() {
                ...
                if (i || (i = this.getInstance(t, !1, n)), (e[t] = i) && (i.styles && (window.mt.data.styles = nge.Lib.Helper.objectApply(window.mt.data.styles, i.styles)), i.assets && i.assets.contents && 0 < i.assets.contents.length && 0 === window.mt.data.assets.contents.filter((function(e) {
                        return e.name === o + "Com"
                    })).length && window.mt.data.assets.contents.push({
                        name: o + "Com",
                        contents: mt.tplsPathsPrepare(i.assets.contents)
                    }), i.objects && i.objects.contents && 0 < i.objects.contents.length)) {
                    var a;
                    if (t = window.mt.data.objects, (s = mt.findItemInTemplate("name", s + "State", mt.data.objects)) && (a = mt.findItemInTemplate("name", o + "Container", s)), a && (t = a), t.contents || (t.contents = []), mt.findItemInTemplate("name", o + "Com", t)) return !1;
                    t.contents.push({
        ...
        nge.Com.Buttons.Controller = nge.Com.Base.extend((function() {
            var e, t;
            this._cfg = null, this.create = function() {
                this.createDefault(), e = this;
                var n = this.getInstance("Cfg");
                e._cfg = n.get(), (n = nge.localData.get("brain.restoreGame")) && n.lastResponse && "FreeSpinReady" === n.lastResponse.state && (e._paytableButtonDisable(), e._settingsButtonDisable(), e._euroButtonDisable()), t || e._subscribe(), t = !0
            }, this._paytableButtonEnable = function() {
                e._enableButton(e._cfg.paytableButton, !0)
            }, this._paytableButtonDisable = function() {
                e._enableButton(e._cfg.paytableButton, !1)
            }, this._settingsButtonEnable = function() {
                e._enableButton(e._cfg.settingsButton, !0)
            }, this._settingsButtonDisable = function() {
                e._enableButton(e._cfg.settingsButton, !1)
            }, this._euroButtonEnable = function() {
                e._enableButton(e._cfg.euroButton, !0)
            }, this._euroButtonDisable = function() {
                e._enableButton(e._cfg.euroButton, !1)
            }, this._enableButton = function(e, t) {
                (e = nge.find("^" + e)) && (t ? e.enable(1) : e.disable(3))
            }, this._subscribe = function() {
                nge.observer.add("paytableButton.disable", e._paytableButtonDisable), nge.observer.add("paytableButton.enable", e._paytableButtonEnable), nge.observer.add("settingsButton.disable", e._settingsButtonDisable), nge.observer.add("settingsButton.enable", e._settingsButtonEnable), nge.observer.add("euroButton.disable", e._euroButtonDisable), nge.observer.add("euroButton.enable", e._euroButtonEnable)
            }
        }))
    }, function(e, t) {
        nge.Com.ClearButton = {}
        ...
        nge.Com.Debug.Controller = nge.Com.Base.extend((function() {
            this._logicBlocks = "coords fps observer plugin renderStat resolution versions".split(" ");
            var e, t = !1,
                n = !0,
                i = !1;
            this.preload = function() {
                ...
                return e = this, "production" !== nge.Cfg.Main.mode && (this.createDefault(), i = nge.findOne("^debugCom"), nge.Lib.Helper.logicBlocksDo(this, "create"), t || (nge.Lib.Helper.logicBlocksDo(this, "subscribe"), e._subscribe(), t = !0), !0)
        ...
        nge.Com.Debug.Observer = Class.extend((function() {
            var e = this,
                ...
                n = {};
            this.create = function() {
                return nge.localData.get("debug.observer.created") ? e.show(!1) : (i(), nge.localData.set("debug.observer.created", !0)), l(), nge.observer.debugFire = a, !0
            ...
            var s = function() {
                ...
                a = function(e, t) {
                    for (var i in n)
                        ...
                        var o = nge.Lib.Helper.strReplace("*", "", i);
                        new RegExp(o, "ig").test(e) && r(e, n[i], t)
                    }
                },
                r = function(e, t, n) {
                    n && (e += " | " + JSON.stringify(n)), log("%c" + e, "color: " + t)
                },
                l = function() {
            ...
            var u = '<li class="{className}"><input type="button" onclick="nge.observer.fire(\'debug.observer.remove\',\'{name}\');" value="X"> <font style="color:{color};">{name}</font></li>'
        }))
    }, function(e, t) {
                        ...
                        for (var i = 0; i < e.length; i++) {
                            ...
                            if (o.visible) {
                                ...
                                for (var s = 0; s < o.length; s++) {
                                    var a = o[s];
                                    a.visible && (n.pxSprite += Math.abs(a.width * a.height), n.nSprite++)
                                }
                            }
                        }
                    }
        ...
        nge.Com.LoadAssets.Controller = nge.Com.Base.extend((function() {
            var e, t, n, i, o = !1,
                ...
                a = !1;
            this.preload = function() {
                this.preloadDefault(), e = this, t = nge.App.getInstance("Com.Load.Cfg"), e._preloadScrollbars(), e._preloadLoader(), e._preloadAtlases(), e._preloadBitmapFonts()
            }, this.create = function() {
                n = nge.Lib.Time.get(), e._preloadSounds(), i || (this.subscribe(), i = !0), nge.Lib.Checker.delay((function() {
                ...
                e.preloadDefault(nge.tpl.group("scrollbarVertical")), e.preloadDefault(nge.tpl.group("scrollbarHorizontal"))
        ...
        nge.Com.SlotMachine.RecyclerReel = nge.Com.Base.extend((function() {
            ...
            this.init = function(t) {
                ...
                t = void 0 === t ? 1 : t, e._running || e._onhold || (e._stopping = !1, e._running = !0, e._lastSymbols = [], e.setCounter(999999), e.onStart(e, (function() {
                    e._tween = nge.tween.add(e._container, !0), e.resetPosition(), e.switchBorders(!0), e.setSpeed(e._normalSpeed), e.step(e._stepDuration, t)
                })))
            ...
            }, this.step = function(t, n) {
                t = void 0 === t ? 100 : t, n = void 0 === n ? 1 : n, e._tween.to({
                    y: e._container.y + e._symbolSize.height * n
                }, t), e._requiredTimeScale && e._tween.timeScale !== e._requiredTimeScale && (e._tween.timeScale = e._requiredTimeScale, delete e._requiredTimeScale), e._tween.onComplete.addOnce((function() {
                    if (e.recycle(n), 0 < n) {
                    ...
                    e.onStop(e, (function() {
                        e.resetPosition(), e._running = !1, e.switchBorders(!e._hideBorderSymbols)
                    }))
                })), e._tween.start()
        ...
        nge.Com.SlotMachine.RecyclerView = Class.extend((function() {
            var e = this;
            this._service = this._cfg = null, this._symbols = {}, this._helper = null, this._symbolSize = {
                width: 1,
                height: 1
                ...
                for (i = 0; i < e._cfg.mw; i++) {
                    ...
                    }), a.onStart = e._onReelStart, a.onStop = e._onReelStop, e._reelsContainer.add(s), e._reels.push(a)
                }
            }, this._onReelStart = function(t, n) {
                var i = t.getIndex() * e._cfg.tweenStartInterval;
                e.customReelStartCallback(t, i, n), nge.observer.fire("slotMachine.reelAnimationStart", t.getIndex(), i), nge.observer.fire("slotMachine.reel_" + t.getIndex() + ".animation.start", i)
            }, this._onReelStop = function(t, n) {
                e.customReelStopCallback(t, t.getIndex()), nge.observer.fire("slotMachine.reel_" + t.getIndex() + ".animation.stop"), nge.observer.fire("slotMachine.reel_" + t.getIndex() + ".animation.stopped"), e._checkIntrigue(t.getIndex()), t = e._reels.filter((function(e) {
                    return e.isOnHold()
                })).length, ++e._reelsStoped == e._reels.length - t && nge.rafSetTimeout((function() {
                    e._service.spinCompleteCallback()
                }), e._cfg.spinCompleteDelay), n()
                ...
                t = void 0 === t ? "forward" : t, e._spinDirection = t, e._requestStartTime = nge.Lib.Time.get(), e._speedUp = !1;
                for (var n = e._reelsStoped = 0; n < e._reels.length; n++) e._reels[n].start("forward" === t ? 1 : -1)
            ...
            }, this.customReelStartCallback = function(e, t, n) {
                nge.rafSetTimeout(n, t)
            }, this.customReelStopCallback = function(e, t) {}, this.reelSpinsFinishTweenOnUpdateCallback = this.reelSpinsStartTweenOnUpdateCallback = !1
        }))
    }, function(e, t) {
        ...
        n(169), n(170), n(171), n(172), n(173), n(175), n(176), n(177), n(178), n(179), n(180), n(181), n(182), n(183), n(184), n(185), n(186), n(187), n(188), n(189), n(190), n(191), n(192), n(193)
    }, function(e, t) {
        nge.Lib = {}
    }, function(e, t) {
        ...
        "undefined" == typeof nge && (nge = {}), nge.Lib || (nge.Lib = {}), nge.Lib.Helper = {
            ...
            mergeObjs: function(e, t, n) {
                for (var i in n = n || nge.Lib.Helper.jsObjClone(e), t) n[i] = t[i];
                return n
            },
            ...
            setCookie: function(e, t, n) {
                var i = new Date;
                return i.setDate(i.getDate() + n), t = escape(t) + (null === n ? "" : "; expires=" + i.toUTCString()), document.cookie = e + "=" + t, !0
            },
        ...
        nge.Lib.Observer = function() {
            ...
            this.add = function(i, s, r, l) {
                ...
                a = e
            }, this.fire = function(r, l, c, u) {
                if ("object" == typeof r) {
                    var g = r;
                    r = g.eventName, l = g.params, c = g.delay, g = void 0
                }
                if (!r) return console.error("nge.Lib.Observer error: no eventName. Check your code"), !1;
                if (u || (u = {
                        callee: arguments.callee,
                        caller: arguments.callee.caller
                    }), c) return nge.rafSetTimeout((function() {
                    nge.observer.fire(r, l, 0, u)
                }), c), !0;
                if (c = 0, n) return s.push([r, l, c, u]), !1;
                this.debugFire(r, l), n = !0, i.push(r), g = "_@" + a;
                var f = function(e, t, n, i) {
                    if (void 0 !== e[t])
                        for (var o in e[t])(0, e[t][o])(n, i)
                };
                if (f(e, r, l, u), f(t, r, l, u), f(e, r += g, l, u), f(t, r, l, u), i.pop(), 0 === i.length) {
                    for (var p in n = !1, g = o) f = g[p], this.add(f[0], f[1], f[2], f[3]);
                    o = [], 0 < s.length && (p = s.shift(), this.fire(p[0], p[1], p[2], p[3]))
                }
                return !0
            }, this.debugFire = function(e, t) {}
        }
    }, function(e, t) {
        ...
        nge.Lib.SelfCheckTools = {
            ...
            showChanges: function() {
                for (var e in console.log(this._len + " ~~ " + nge.Lib.Helper.getObjSize(window)), window) - 1 === this._windowKeys.indexOf(e) && console.log("---" + e, window[e]);
                return !0
            },
            deepDiffMapper: {
        ...
        window.Phaser && window.Phaser.Signal ? nge.Lib.Signal = window.Phaser.Signal : ((e = function() {
            this.listeners = []
        }).prototype.addOnce = function(e, t, n, i) {
            this.listeners.push({
            ...
            var t = this.listeners.findIndex((function(t) {
                return t.callback === e
            }));
        ...
        nge.Lib.Tweens = function() {
            ...
            }), this.tweens = e, this.add = function(i) {
        ...
        n(195), n(196), n(197), n(198), n(199), n(200), n(201), n(202), n(203), n(204), n(205), n(206), n(207), n(208)
    }, function(e, t) {
        nge.Tpl = {}
    }, function(e, t) {
        nge.Tpl.Groups = {}
        ...
        nge.App.Run = function() {
            this.run = function() {
                ...
                nge.Cfg.Main.lang = nge.Lib.Helper.parseGetParams("lang") || nge.Cfg.Main.lang, nge.i18n = new nge.Lib.I18n(nge.Cfg.Main.project), nge.observer = new nge.Lib.Observer, nge.tween = new nge.Mlm.TweenManager.Controller, nge.clickEffects = new nge.Mlm.ClickEffects.Controller, nge.localData = new nge.Mlm.LocalData.Controller, nge.statesManager = new nge.Mlm.StatesManager.Controller, nge.tpl = new nge.Mlm.Tpl.Controller, nge.assets = new nge.Mlm.Assets.Controller, nge.objects = new nge.Mlm.Objects.Controller, nge.objects.init(), nge.device = nge.Lib.Device, t(), nge.Lib.Helper.mobileAndTabletCheck() && nge.App.addSysInstancesMode("mobile"), log("_sysInstancesModes", nge.App.getSysInstancesModes());
                var n = nge.App.getInstance("Run", !0);
                nge.soundManager = new nge.Mlm.SoundManager.Controller, nge.soundManager.init(), nge.transport = new nge.Mlm.Transport.Controller, nge.transport.init(), nge.keyboard = new nge.Lib.Keyboard, nge.mouse = new nge.Lib.Mouse, nge.resolutionsManager = new nge.Mlm.ResolutionsManager.Controller, nge.resolutionsManager.init(), nge.animator = new nge.Mlm.Animator.Controller, nge.animator.init(), nge.assets.init(), nge.brain = nge.App.getInstance("Mlm.Brain.Controller"), nge.brain.init(), nge.cheatsManager = nge.App.getInstance("Mlm.CheatsManager.Controller"), nge.cheatsManager.init(), nge.audioInterfacesManager = nge.App.getInstance("Mlm.AudioInterfacesManager.Controller"), nge.audioInterfacesManager.init(), nge.api = new nge.Lib.Api;
                var i, s = function() {
                    i = setTimeout((function() {
                        clearTimeout(i), nge.observer.fire("window.resize")
                    }), 250)
                };
                return nge.game.scale.onFullScreenChange.add(s), $(window).resize(s), $(window).on("orientationchange", s), document.addEventListener("visibilitychange", (function() {
                    ...
                    play: ["play"]
                }), o(), n ? n.run() : nge.statesManager.display("load"), !0
            };
            var e = function() {
                ...
                t = function() {
                    ...
                    }, nge.App.getPath = function(e, t, n, o) {
                        return i({
                            path: e,
                            appOnly: t,
                            callback: function(e) {
                ...
                i = function(e) {
                    ...
                    if (t in n) return !!n[t] && e.callback(n[t]);
                    n[t] = !1;
                    var i = e.path.split("."),
                        o = nge.Lib.Helper.capitaliseFirstLetter(nge.Cfg.Main.project),
                        s = nge.App.getSysInstancesModes(),
                        a = [];
                    return o = nge.Lib.Helper.mergeArrs(["nge", "App", o], i), a.push(o), e.appOnlyFlag || (i = nge.Lib.Helper.mergeArrs(["nge"], i), a.push(i)), s = nge.App.getSysInstancesModes(), nge.Lib.Checker.paths(a, (function(i) {
                        return n[t] = i, e.callback(i)
                    }), s)
                },
                o = function() {
                    var e = nge.Cfg.Main,
                        t = e.title + " v." + e.version + " - " + e.gameVersion;
                    nge.localData.set("version", e.version)
                }
        }
    }, function(e, t) {
